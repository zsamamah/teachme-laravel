...
<div class="form-container">
  <form method="POST" action="{{ route('save-visa',$order->id) }}">
    @csrf
    <div class="field-container">
        <label for="name">Name</label>
        <input id="name" name="c_name" maxlength="20" type="text">
    </div>
    <div class="field-container">
        <label for="cardnumber">Card Number</label><span id="generatecard">generate random</span>
        <input id="cardnumber" name="c_num" type="text" pattern="[0-9]*" inputmode="numeric">
    ...
    <div class="field-container">
        ...
        <input id="expirationdate" name="exp" type="text" pattern="[0-9]*" inputmode="numeric">
    </div>
    <div class="field-container">
...
<!-- Javascript Files
  ...
  <script defer src="{{ asset('https://unpkg.com/imask') }}"></script>
