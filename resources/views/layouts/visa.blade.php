  ...
  @csrf
    ...
    <div class="form-container">
      ...
      <div class="field-container">
        ...
        <input id="cardnumber" name="card_no" type="text" pattern="[0-9 ]*" inputmode="numeric" required>
      ...
      <div class="field-container">
        ...
        <input id="expirationdate" name="exp" type="text" pattern="[0-9/]*" inputmode="numeric" required>
      </div>
      <div class="field-container">
        <label for="securitycode">Security Code</label>
        <input id="securitycode" name="code" type="text" pattern="[0-9]*" inputmode="numeric" required>
